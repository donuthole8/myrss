...
export const CATALOG: CatalogCategory[] = [
  ...
  },
  {
    ...
    feeds: [
      ...
      en("https://nodeweekly.com/rss/", "Node Weekly", "https://nodeweekly.com", "Node.js の週刊ニュースレター"),
      en("https://pycoders.com/feed", "PyCoder's Weekly", "https://pycoders.com", "Python の週刊ニュースレター"),
  ...
  },
  {
    id: "lang",
    title: "言語・ランタイム",
    description: "プログラミング言語の公式ブログと、言語ごとの読み物",
    folder: "言語",
    feeds: [
      ...
      en("https://bun.sh/rss.xml", "Bun Blog", "https://bun.com", "Bun のリリースと機能紹介"),
      ja("https://www.ruby-lang.org/ja/feeds/news.rss", "Ruby ニュース", "https://www.ruby-lang.org/ja/", "Ruby 公式サイトのニュース"),
      en("https://www.php.net/feed.atom", "PHP.net News", "https://www.php.net", "PHP 公式のリリースとカンファレンス告知"),
      en("https://stitcher.io/rss", "stitcher.io", "https://stitcher.io", "PHP の新機能と設計の読み物。PHP 財団の Brent Roose"),
      en("https://blog.python.org/feeds/posts/default", "Python Insider", "https://blog.python.org", "Python コア開発チームのブログ。リリースと PEP の動き"),
      en("https://realpython.com/atom.xml", "Real Python", "https://realpython.com", "Python のチュートリアルと解説記事"),
      en("https://inside.java/feed.xml", "Inside Java", "https://inside.java", "Oracle の Java チームによるニュースと解説"),
      en("https://blog.jetbrains.com/kotlin/feed/", "Kotlin Blog", "https://blog.jetbrains.com/kotlin/", "JetBrains 公式の Kotlin ブログ"),
      en("https://www.swift.org/atom.xml", "Swift.org", "https://www.swift.org", "Swift 公式ブログ"),
      en("https://devblogs.microsoft.com/dotnet/feed/", ".NET Blog", "https://devblogs.microsoft.com/dotnet/", "C# / .NET のリリースと解説"),
      en("https://www.scala-lang.org/feed/index.xml", "Scala", "https://www.scala-lang.org", "Scala 公式のニュースとブログ"),
      en("https://isocpp.org/blog/rss", "Standard C++", "https://isocpp.org", "C++ 標準化の動きと記事の紹介"),
    ],
  },
  {
    id: "framework",
    title: "フレームワーク",
    description: "サーバーサイドのフレームワーク公式ブログ",
    folder: "フレームワーク",
    feeds: [
      en("https://feeds.feedburner.com/symfony/blog", "Symfony Blog", "https://symfony.com/blog", "Symfony のリリースと週刊の開発まとめ"),
      en("https://blog.laravel.com/feed", "Laravel Blog", "https://blog.laravel.com", "Laravel 公式ブログ"),
      en("https://laravel-news.com/feed", "Laravel News", "https://laravel-news.com", "Laravel と PHP 周りのニュース・パッケージ紹介"),
      en("https://www.djangoproject.com/rss/weblog/", "Django Weblog", "https://www.djangoproject.com/weblog/", "Django のリリースとセキュリティ告知"),
      en("https://rubyonrails.org/feed.xml", "Ruby on Rails", "https://rubyonrails.org", "Rails のリリースと週刊の変更まとめ"),
      en("https://spring.io/blog.atom", "Spring Blog", "https://spring.io/blog", "Spring Boot / Spring Framework のリリースと解説"),
    ],
  },
  {
    id: "lang-jp",
    title: "言語別の記事 (国内)",
    description: "Zenn と Qiita の言語トピック・タグの新着",
    folder: "言語",
    feeds: [
      ja("https://zenn.dev/topics/php/feed", "Zenn: PHP", "https://zenn.dev/topics/php", "Zenn の PHP トピック"),
      ja("https://qiita.com/tags/php/feed", "Qiita: PHP", "https://qiita.com/tags/php", "Qiita の PHP タグの新着"),
      ja("https://qiita.com/tags/symfony/feed", "Qiita: Symfony", "https://qiita.com/tags/symfony", "Qiita の Symfony タグの新着。投稿はまばら"),
      ja("https://zenn.dev/topics/laravel/feed", "Zenn: Laravel", "https://zenn.dev/topics/laravel", "Zenn の Laravel トピック"),
      ja("https://zenn.dev/topics/python/feed", "Zenn: Python", "https://zenn.dev/topics/python", "Zenn の Python トピック"),
      ja("https://qiita.com/tags/python/feed", "Qiita: Python", "https://qiita.com/tags/python", "Qiita の Python タグの新着"),
      ja("https://zenn.dev/topics/go/feed", "Zenn: Go", "https://zenn.dev/topics/go", "Zenn の Go トピック"),
      ja("https://zenn.dev/topics/rust/feed", "Zenn: Rust", "https://zenn.dev/topics/rust", "Zenn の Rust トピック"),
      ja("https://zenn.dev/topics/ruby/feed", "Zenn: Ruby", "https://zenn.dev/topics/ruby", "Zenn の Ruby トピック"),
      ja("https://zenn.dev/topics/java/feed", "Zenn: Java", "https://zenn.dev/topics/java", "Zenn の Java トピック"),
      ja("https://zenn.dev/topics/kotlin/feed", "Zenn: Kotlin", "https://zenn.dev/topics/kotlin", "Zenn の Kotlin トピック"),
      ja("https://zenn.dev/topics/swift/feed", "Zenn: Swift", "https://zenn.dev/topics/swift", "Zenn の Swift トピック"),
      ja("https://zenn.dev/topics/csharp/feed", "Zenn: C#", "https://zenn.dev/topics/csharp", "Zenn の C# トピック"),
      ja("https://zenn.dev/topics/flutter/feed", "Zenn: Flutter", "https://zenn.dev/topics/flutter", "Zenn の Flutter トピック"),
    ],
  },
  {
    id: "releases",
    title: "リリース情報 (GitHub)",
    description: "言語処理系のリリースをタグ単位で追う。ほかのリポジトリも URL を貼れば購読できる",
    folder: "リリース",
    feeds: [
      en("https://github.com/php/php-src/releases.atom", "php-src のリリース", "https://github.com/php/php-src", "PHP 本体のリリース。パッチ版まで出る"),
      en("https://github.com/symfony/symfony/releases.atom", "Symfony のリリース", "https://github.com/symfony/symfony", "Symfony のリリースと変更点"),
      en("https://github.com/python/cpython/tags.atom", "CPython のタグ", "https://github.com/python/cpython", "Python 本体のバージョンタグ"),
      en("https://github.com/nodejs/node/releases.atom", "Node.js のリリース", "https://github.com/nodejs/node", "Node.js のリリースノート"),
      en("https://github.com/golang/go/tags.atom", "Go のタグ", "https://github.com/golang/go", "Go 本体のバージョンタグ"),
      en("https://github.com/rust-lang/rust/releases.atom", "Rust のリリース", "https://github.com/rust-lang/rust", "Rust のリリースノート"),
    ],
  },
];
